...
function checkdata1()
{
  ...
  alert("识别可能需要一段时间，请耐心等待^_^～～");
  document.getElementById("wn").innerHTML="识别中，请稍后...";
  return true;
}
</script>
...
?>
    ...
    <div class="col-md-5 ">
       <div >
  <form  action="" method="post" enctype="multipart/form-data" name = "form"    onsubmit="return checkdata1()" >
        <br/>
